...
const translations: Translations = {
  ...
  strat_watch_video: { en: 'Watch Dueling Guide / Video', pt: 'Assistir Guia / Vídeo de Duelo', ja: 'デュエルガイド・動画を見る' },
  strat_empty_list: { en: 'No strategies found. Be the first to share one!', pt: 'Nenhuma estratégia encontrada. Seja o primeiro a compartilhar uma!', ja: '戦略が見つかりません。最初の戦略を共有しましょう！' },
  ...
  strat_placeholder_title: { en: 'Ex: Exodia OTK Consistent Combo', pt: 'Ex: Combo Consistente de Exodia OTK', ja: '例: エクゾディア OTK 安定コンボ' },
  strat_placeholder_content: { en: 'Explain your deck mechanics, win conditions, and key combos...', pt: 'Explique a mecânica do seu deck, condições de vitória e combos principais...', ja: 'デッキの仕組み、勝利条件、主要なコンボについて説明してください...' },
  strat_login_required: { en: 'Please login to share your dueling strategy!', pt: 'Por favor, faça login para compartilhar sua estratégia de duelo!', ja: 'デュエル戦略を共有するにはログインしてください！' },
  strat_success_msg: { en: 'Strategy published successfully! Inspiring fellow duelists...', pt: 'Estratégia publicada com sucesso! Inspirando outros duelistas...', ja: '戦略が正常に公開されました！仲間のデュエリストにインスピレーションを与えています...' },
  strat_error_msg: { en: 'An error occurred while publishing.', pt: 'Ocorreu um erro ao publicar.', ja: '公開中にエラーが発生しました。' },
  strat_publishing: { en: 'Publishing...', pt: 'Publicando...', ja: '公開中...' },
